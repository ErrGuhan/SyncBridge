        ...
        <div className="flex items-center gap-1.5 sm:gap-2 xl:gap-2.5 shrink-0">
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="hidden sm:inline font-semibold">
                <span className="hidden 2xl:inline">Commercial </span>Portals
              </span>
          ...
          {user ? (
            <Link
              ...
              className="hidden sm:flex h-9 sm:h-10 px-2 sm:px-2.5 xl:px-3 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-semibold items-center gap-1.5 transition-colors border border-slate-200 shrink-0 whitespace-nowrap"
            ...
            <Link
              href="/auth/login"
              className="hidden sm:flex h-9 sm:h-10 px-2.5 sm:px-3 xl:px-3.5 rounded-lg bg-slate-900 hover:bg-slate-800 text-white text-xs font-semibold items-center gap-1.5 shadow-2xs transition-colors shrink-0 whitespace-nowrap"
            >
