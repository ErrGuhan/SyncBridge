...
export const servicesTranslations: Record<string, TranslationItem> = {
  ...
  confirmModalSubtitle: { en: 'Instant lock with transparent 90/5/3/2 cooperative revenue split', hi: 'पारदर्शी 90/5/3/2 सहकारी राजस्व विभाजन के साथ तत्काल पुष्टि', kn: 'ಪಾರದರ್ಶಕ 90/5/3/2 ಸಹಕಾರಿ ಆದಾಯ ವಿಭಜನೆಯೊಂದಿಗೆ ತಕ್ಷಣ ದೃಢೀಕರಿಸಿ', ta: 'வெளிப்படையான 90/5/3/2 கூட்டுறவு பகிர்வுடன் உடனடி உறுதி' },
  ...
  breakdownHeading: { en: 'Transparent Financial Distribution (90/5/3/2)', hi: 'पारदर्शी वित्तीय वितरण (90/5/3/2)', kn: 'ಪಾರದರ್ಶಕ ಆರ್ಥಿಕ ವಿತರಣೆ (90/5/3/2)', ta: 'வெளிப்படையான நிதிப் பகிர்வு (90/5/3/2)' },
  ...
  shareSociety: { en: '5% Co-op Admin Fund:', hi: '5% समिति साझा उपकरण बैंक:', kn: '5% ಸಂಘದ ಯಂತ್ರೋಪಕರಣ ನಿಧಿ:', ta: '5% சங்கத்தின் கருவி நிதி:' },
  shareWelfare: { en: '3% Welfare & Insurance Shield:', hi: '3% कल्याण एवं बीमा कोष:', kn: '3% ಕಲ್ಯಾಣ & ವಿಮೆ ನಿಧಿ:', ta: '3% நலன் & காப்பீடு கவசம்:' },
