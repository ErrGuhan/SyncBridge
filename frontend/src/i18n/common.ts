...
export const commonTranslations: Record<string, TranslationItem> = {
  ...
  navFederation: { en: 'Federation Admin', hi: 'महासंघ प्रशासन', kn: 'ಒಕ್ಕೂಟದ ಆಡಳಿತ', ta: 'கூட்டமைப்பு நிர்வாகம்' },
  ...
  footerAuditedCharter: { en: 'Audited 90/5/3/2 Charter', hi: 'ऑडिटेड 90/5/3/2 चार्टर', kn: 'ಲೆಕ್ಕಪರಿಶೋಧಿತ 90/5/3/2 ಸನ್ನದು', ta: 'தணிக்கை செய்யப்பட்ட 90/5/3/2 சாசனம்' },
  footerWorkerTakeHome: { en: 'Worker Take-Home', hi: 'कारीगर की आय', kn: 'ಕಾರ್ಮಿಕರ ಆದಾಯ', ta: 'தொழிலாளர் வருவாய்' },
  footerSocietyReserve: { en: 'Co-op Admin', hi: 'समिति प्रशासन', kn: 'ಸಂಘದ ಆಡಳಿತ', ta: 'சங்க நிர்வாகம்' },
  footerWelfareTrust: { en: 'Welfare & Insurance', hi: 'कल्याण एवं बीमा', kn: 'ಕಲ್ಯಾಣ ಮತ್ತು ವಿಮೆ', ta: 'நலன் மற்றும் காப்பீடு' },
  footerTechFund: { en: 'Platform Tech', hi: 'प्लेटफॉर्म तकनीक', kn: 'ಪ್ಲ್ಯಾಟ್‌ಫಾರ್ಮ್ ತಂತ್ರಜ್ಞಾನ', ta: 'தள தொழில்நுட்பம்' },
  footerHostedOn: { en: 'Designed for MeghRaj (GI Cloud) deployment', hi: 'मेघराज (सरकारी क्लाउड) परिनियोजन के लिए डिज़ाइन किया गया', kn: 'ಮೇಘ್‌ರಾಜ್ (ಸರ್ಕಾರಿ ಕ್ಲೌಡ್) ನಿಯೋಜನೆಗಾಗಿ ವಿನ್ಯಾಸಗೊಳಿಸಲಾಗಿದೆ', ta: 'மேக்ராஜ் (அரசு கிளவுட்) பயன்பாட்டிற்காக வடிவமைக்கப்பட்டது' },
  footerDPDP: { en: 'DPDP Act 2023-aligned architecture', hi: 'DPDP अधिनियम 2023-संरेखित आर्किटेक्चर', kn: 'DPDP ಕಾಯಿದೆ 2023-ಸಂಯೋಜಿತ ವಾಸ್ತುಶಿಲ್ಪ', ta: 'DPDP சட்டம் 2023-இணக்கமான கட்டமைப்பு' },
