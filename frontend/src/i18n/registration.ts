...
export const registrationTranslations: Record<string, TranslationItem> = {
  ...
  coopPledge: { en: 'Democratic Pledge: I agree to uphold the 90/5/3/2 cooperative distribution, serve customers fairly, and resolve disputes through democratic peer arbitration.', hi: 'लोकतांत्रिक प्रतिज्ञा: मैं 90/5/3/2 सहकारी वितरण का पालन करने, ग्राहकों को निष्पक्ष सेवा देने और विवादों को सहकर्मी परिषद के माध्यम से सुलझाने की शपथ लेता हूं।', kn: 'ಪ್ರಜಾಸತ್ತಾತ್ಮಕ ಪ್ರತಿಜ್ಞೆ: ನಾನು 90/5/3/2 ಸಹಕಾರಿ ವಿತರಣೆಯನ್ನು ಪಾಲಿಸಲು ಮತ್ತು ವಿವಾದಗಳನ್ನು ಮಧ್ಯಸ್ಥಿಕೆ ಮೂಲಕ ಪರಿಹರಿಸಲು ಒಪ್ಪುತ್ತೇನೆ.', ta: 'ஜனநாயக உறுதிமொழி: நான் 90/5/3/2 கூட்டுறவு பகிர்வுக்கு இணங்கி, நேர்மையாக சேவை செய்ய உறுதியளிக்கிறேன்.' },
